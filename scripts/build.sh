...
uglifyjs js/model.js js/prototypes.js js/storage.js js/audio_controller.js js/alert.js js/information.js js/keyboard_shortcuts.js js/midi/midi_controller.js js/window_resize.js js/setup_controls.js js/main.js js/install.js service_worker.js -o js/bundle.js
